...
import {Pausable} from "../lib/eigenlayer-contracts/src/contracts/permissions/Pausable.sol";

import {IZrServiceManager} from "./interfaces/IZrServiceManager.sol";
import {ZrRegistryCoordinatorStorage} from "./ZrRegistryCoordinatorStorage.sol";
 ...
 */
contract ZrRegistryCoordinator is
    EIP712,
    Initializable,
    Pausable,
    OwnableUpgradeable,
    ZrRegistryCoordinatorStorage,
    ISignatureUtils
{
    ...
    constructor(
        IZrServiceManager _serviceManager,
    ...
    *******************************************************************************/
    ...
    function _checkEjector() internal view {
        require(
            msg.sender == ejector,
            "RegCoord.onlyEjector: caller is not the ejector"
        );
    }
    ...
    function _validateChurn(
        ...
        require(
            ...
            "RegCoord._validateChurn: cannot churn self"
        );
        require(
    ...
    function _deregisterOperator(
        ...
        require(
            !quorumsToRemove.isEmpty(),
            "RegCoord._deregisterOperator: bitmap cannot be 0"
        );
        require(
            quorumsToRemove.isSubsetOf(currentBitmap),
    ...
    function _createQuorum(
        ...
        require(
            ...
            "RegCoord.createQuorum: max quorums reached"
        );
