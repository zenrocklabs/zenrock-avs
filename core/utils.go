...
// this hardcodes abi.encode() for cstaskmanager.ZrServiceManagerLibTaskResponse
...
func AbiEncodeTaskResponse(h *cstaskmanager.ZrServiceManagerLibTaskResponse) ([]byte, error) {
	...
	// The order here has to match the field ordering of cstaskmanager.ZrServiceManagerLibTaskResponse
