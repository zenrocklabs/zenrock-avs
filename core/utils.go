...
func AbiEncodeTaskResponse(h *cstaskmanager.ZRTaskManagerITaskResponse) ([]byte, error) {
...
func GetTaskResponseDigest(h *cstaskmanager.ZRTaskManagerITaskResponse) ([32]byte, error) {
