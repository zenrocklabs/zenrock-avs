...
replace (
	...
	github.com/zenrocklabs/zenrock/tools/go-client => ../zenrock/tools/go-client
)
...
require (
	...
	github.com/shamaton/msgpack/v2 v2.2.1 // indirect
	...
	github.com/zenrocklabs/zenbtc v0.0.3 // indirect
